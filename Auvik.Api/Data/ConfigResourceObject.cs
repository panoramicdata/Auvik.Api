...
namespace Auvik.Api.Data
{
	...
	public class ConfigResourceObject
	{
		...
		/// <summary>
		/// The unique identifier for a configuration
		/// </summary>
		/// <value>The unique identifier for a configuration</value>
		...
		public ConfigResourceObjectLinks Links { get; set; }

		/// <summary>
		/// Gets or Sets Relationships
		/// </summary>
		[DataMember(Name="relationships", EmitDefaultValue=false)]
		public ConfigRelationships Relationships { get; set; }
		...
		public override string ToString()
		{
			...
			sb.Append("class ConfigResourceObject {\n");
