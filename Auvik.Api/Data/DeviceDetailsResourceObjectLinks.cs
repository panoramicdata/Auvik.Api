...
namespace Auvik.Api.Data
{
	...
	/// </summary>
	[DataContract]
	public class DeviceDetailsResourceObjectLinks
	{
		/// <summary>
		...
		/// <summary>
		/// Link to this set of device details
		/// </summary>
		/// <value>Link to this set of device details</value>
		...
		public override string ToString()
		{
			...
			sb.Append("class DeviceDetailsResourceObjectLinks {\n");
